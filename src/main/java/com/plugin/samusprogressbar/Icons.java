...
public class Icons {
    ...
    public static ImageIcon SAMUS_POWER_SUIT = new ImageIcon(Icons.class.getResource("/settings/samus_power_suit.gif"), "Samus (Power Suit)");
    public static ImageIcon SAMUS_POWER_SUIT_BAR = new ImageIcon(Icons.class.getResource("/progressbar/samus_power_suit_bar.gif"), "Samus (Power Suit)");

    public static ImageIcon SAMUS_GRAVITY_SUIT = new ImageIcon(Icons.class.getResource("/settings/samus_gravity_suit.gif"), "Samus (Gravity Suit)");
    public static ImageIcon SAMUS_GRAVITY_SUIT_BAR = new ImageIcon(Icons.class.getResource("/progressbar/samus_gravity_suit_bar.gif"), "Samus (Gravity Suit)");

    public static ImageIcon SAMUS_ZERO_SUIT = new ImageIcon(Icons.class.getResource("/settings/samus_zero_suit.gif"), "Samus (Zero Suit)");
    public static ImageIcon SAMUS_ZERO_SUIT_BAR = new ImageIcon(Icons.class.getResource("/progressbar/samus_zero_suit_bar.gif"), "Samus (Zero Suit)");
